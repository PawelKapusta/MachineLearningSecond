...
axes.text(0.7, 0.3, "Value auc train = {:4.4f}".format(auc_t_2), fontsize=12)
axes.text(0.7, 0.25, "Value auc test = {:4.4f}".format(auc_t_2 - auc_t), fontsize=12)
axes.legend(loc='lower right', bbox_to_anchor=(0.95, 0.15))
sb.glue('ROC',fig, "display", display=False)
...
axes.text(0.65, 0.25, "Value advance auc = {:4.4f}".format(auc_all_t - auc_t_2), fontsize=12)
axes.legend(loc='lower right', bbox_to_anchor=(0.95, 0.15))
sb.glue('ROC',fig, "display", display=False)
